...
function do_match() {
  ...
  $.ajax({
    ...
    beforeSend:function(){ 
      ...
      $("body").append('<div id="pload" style="position:fixed;top:30%;z-index:1200;background:url(loading) top center no-repeat;width:100%;height:140px;margin:auto auto;"></div>'); 
